...
import { Plus, Edit, Home, LogOut, Loader2 } from 'lucide-react';
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{property.location.neighborhood}, {property.location.city}</p>
                        </div>
                        <div className="flex gap-2">
